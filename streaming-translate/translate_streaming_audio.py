# This code utilizes the Google python examples from
...
""" Sample application using the Google Speech-to-Text streaming API and
    Cloud Translation AI to translate streaming audio
...
# [START speech_transcribe_translate_infinite_streaming_v2]
...
def translate_text(target: str, text: str, translate_client: object) -> str:
...
def listen_print_loop(responses: object, stream: object, translate_client: object) -> None:
    ...
    for response in responses:
        ...
        if result.is_final:
            ...
            # tranlate the transcribe to Chinese
            translated_transcript = translate_text("zh-CN", transcript, translate_client)

            sys.stdout.write(GREEN)
            sys.stdout.write("\033[K")
            sys.stdout.write(str(corrected_time) + ": " + translated_transcript + "\n")
...
def main(project_id: str) -> None:
    ...
    with mic_manager as stream:
        while not stream.closed:
            ...
            # print(f"Speech-To-Text latency: {elapsed_time_seconds:.4f} seconds")

            listen_print_loop(responses_iterator, stream, translate_client)
